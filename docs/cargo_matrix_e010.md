...
Checkpoint `outputs/cargo/epoch_010.pth` (epoch 10), trained with the same recipe as the AG-ReID.v2 baseline: TransReID-S ViT-S/16, identity + triplet loss, PK sampler, both platforms in the training split. Same recipe is what makes the two matrices comparable.
...
|---|---|---|---|---|
| aerial-ground | 80 | 54.67% | 30.51% | 68.05% |
| aerial-aerial | 20 | 58.09% | 32.96% | 71.75% |
| ground-ground | 56 | 72.65% | 57.15% | 86.30% |
...
|---|---|---|---|---|---|---|
| Cam9 | Cam1 | aerial-ground | 30.51% | 32.67% | 600 | 1805 |
| Cam5 | Cam1 | aerial-aerial | 32.96% | 35.17% | 600 | 1409 |
| Cam1 | Cam9 | aerial-ground | 34.19% | 33.17% | 600 | 1805 |
| Cam11 | Cam1 | aerial-ground | 36.00% | 39.50% | 600 | 1778 |
| Cam13 | Cam1 | aerial-ground | 38.87% | 43.50% | 600 | 1824 |
| Cam1 | Cam5 | aerial-aerial | 39.02% | 36.33% | 600 | 1409 |
| Cam4 | Cam1 | aerial-aerial | 39.11% | 43.50% | 600 | 1397 |
| Cam8 | Cam1 | aerial-ground | 39.11% | 45.00% | 600 | 1799 |
| Cam8 | Cam10 | ground-ground | 83.23% | 84.67% | 600 | 1467 |
| Cam8 | Cam6 | ground-ground | 83.66% | 87.17% | 600 | 1467 |
| Cam12 | Cam10 | ground-ground | 84.33% | 85.50% | 600 | 1401 |
| Cam10 | Cam12 | ground-ground | 86.30% | 86.83% | 600 | 1401 |

- spread across all 156 pairs: **55.79%**
- aerial-ground mean 54.67%, same-platform mean 68.82%, gap **+14.14%**

**Verdict: CARGO RETAINS an aerial-ground gap: same-platform retrieval beats cross-platform by 14.14%.**
